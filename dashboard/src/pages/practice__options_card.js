...
export default class external__practice__options_card extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            id:1,
            ...
            <div className="mb-3">
                ...
                <Card>
                    <CardContent>
                        ...
                        <Button variant="contained" style={{borderRadius:"15px"}} color="primary" onClick={this.SaveAppOptions} >Praxis aktualisieren</Button>
                        </div>
                    </CardContent>
                </Card>
